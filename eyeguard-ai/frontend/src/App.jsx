...
const getMascot = (skin, pupilClass) => {
  const mascots = {
    ...
    scooter: <g><rect x="20" y="80" width="55" height="6" fill="#95a5a6" rx="3" /><rect x="65" y="45" width="6" height="38" fill="#7f8c8d" rx="2" /><rect x="55" y="45" width="20" height="5" fill="#34495e" rx="2" /><rect x="68" y="82" width="4" height="4" fill="#34495e" /><g className="a-wheel" style={{ transformOrigin: '70px 86px' }}><circle cx="70" cy="86" r="6" fill="#2c3e50" /><circle cx="70" cy="86" r="2" fill="#ecf0f1" /></g><rect x="28" y="82" width="4" height="4" fill="#34495e" /><g className="a-wheel" style={{ transformOrigin: '30px 86px' }}><circle cx="30" cy="86" r="6" fill="#2c3e50" /><circle cx="30" cy="86" r="2" fill="#ecf0f1" /></g><g><rect x="25" y="35" width="35" height="30" fill="#f1c40f" rx="8" /><path d="M 25" y="35 Q 42 15 60 35 Z" fill="#d35400" /><rect x="23" y="32" width="39" height="6" fill="#e67e22" rx="2" /><circle cx="40" cy="45" r="6" fill="#fff" /><circle cx="55" cy="45" r="6" fill="#fff" /><circle cx="42" cy="45" r="3" fill="#000" className={pupilClass} /><circle cx="57" cy="45" r="3" fill="#000" className={pupilClass} /><rect x="20" y="52" width="45" height="18" fill="#c0392b" rx="5" /><rect x="35" y="58" width="15" height="10" fill="#e74c3c" rx="2" /><rect x="45" y="43" width="15" height="10" fill="#c0392b" rx="4" /><rect x="55" y="44" width="8" height="8" fill="#f1c40f" rx="2" /><rect x="45" y="70" width="12" height="12" fill="#2980b9" /><rect x="45" y="78" width="18" height="6" fill="#d35400" rx="2" /><rect x="45" y="82" width="18" height="2" fill="#fff" /><g className="a-kick" style={{ transformOrigin: '31px 70px' }}><rect x="25" y="70" width="12" height="12" fill="#2980b9" /><rect x="15" y="78" width="18" height="6" fill="#d35400" rx="2" /><rect x="15" y="82" width="18" height="2" fill="#fff" /></g></g></g>,
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen bg-[#0f926e] relative overflow-hidden font-sans flex flex-col selection:bg-yellow-300 selection:text-slate-900 w-full">
      <header className="relative z-30 px-6 md:px-12 py-6 text-white w-full max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-6 items-center">
          <button onClick={() => { setShowAuth(true); setAuthTab('login'); }} className="font-bold hover:text-yellow-300 text-sm transition-colors tracking-wide">Log in</button>
          <button onClick={() => { setShowAuth(true); setAuthTab('signup'); }} className="bg-yellow-400 text-emerald-900 px-7 py-2.5 rounded-full font-bold text-sm hover:bg-yellow-300 transition-colors shadow-lg">Sign up →</button>
        </div>
      </header>

      <main className="relative z-20 flex flex-col items-center pt-8 md:pt-12 px-4 pointer-events-none w-full">
        <div className="text-center max-w-3xl z-30 pointer-events-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight leading-[1.1] drop-shadow-md">
            Protect the <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-400">eyes</span> <br className="hidden md:block"/> you use every day
          </h1>
          <p className="text-emerald-50 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow">
            Your intelligent health assistant. Using real-time computer vision to monitor blink rates, distance, and fatigue, EyeGuard prevents digital burnout.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <button onClick={() => { setShowAuth(true); setAuthTab('signup'); }} className="bg-white text-emerald-700 px-8 py-3.5 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">Get Started</button>
          </div>
        </div>
      </main>

        <div className="absolute bottom-0 left-0 w-full h-[65vh] overflow-hidden pointer-events-none z-10">
            <svg
        ...
        <svg x="560" y="480" width="130" height="130" viewBox="0 0 100 100" overflow="visible">
          <g className="a-bounce"><path d="M 25 35 Q 25 25 35 25 L 45 25 Q 50 25 50 30 L 50 65 L 25 65 Z" fill="#9575cd" /> 
            ...
            <g className="a-palette">
              <rect x="70" y="38" width="12" height="12" fill="#ff8a65" rx="4" />
              <path d="M 75 35 Q 95 30 90 50 Q 85 60 70 50 Z" fill="#d7ccc8" />
              <circle cx="75" cy="45" r="3" fill="#5d4037" /><circle cx="82" cy="38" r="2" fill="#f44336" />
              <circle cx="88" cy="42" r="2" fill="#2196f3" /><circle cx="85" cy="48" r="2" fill="#ffeb3b" />
            </g>
            <g className="a-paint" style={{ transformOrigin: '23px 51px' }}>
              <rect x="18" y="45" width="10" height="12" fill="#ff8a65" rx="4" />
              <rect x="12" y="20" width="4" height="35" fill="#8d6e63" transform="rotate(-15 14 37)" rx="1" />
              <path d="M 8 15 Q 15 10 18 20 Z" fill="#d32f2f" transform="rotate(-15 14 37)" />
            </g>
            <g transform="translate(85, 25)">
              <line x1="15" y1="10" x2="0" y2="45" stroke="#8b4513" strokeWidth="3" strokeLinecap="round" />
              <line x1="15" y1="10" x2="30" y2="45" stroke="#8b4513" strokeWidth="3" strokeLinecap="round" />
              <line x1="15" y1="10" x2="15" y2="50" stroke="#8b4513" strokeWidth="3" strokeLinecap="round" />
              <rect x="0" y="5" width="30" height="25" fill="#f8fafc" stroke="#e2e8f0" strokeWidth="2" rx="2" />
              <rect x="4" y="9" width="22" height="17" fill="#e0f2fe" />
              <circle cx="20" cy="14" r="3" fill="#fcd34d" />
              <path d="M 4 26 L 10 18 L 16 26 Z" fill="#34d399" />
              <path d="M 12 26 L 18 16 L 26 26 Z" fill="#10b981" />
            </g>
          </g>
        </svg>
        ...
        <svg x="510" y="590" width="180" height="180" viewBox="0 0 100 100" overflow="visible">
          <g className="a-bounce">
            <g className="a-headbang">
              <rect x="25" y="30" width="50" height="35" fill="#d500f9" rx="10" />
              <rect x="30" y="38" width="18" height="8" fill="#212121" rx="2" /><rect x="52" y="38" width="18" height="8" fill="#212121" rx="2" />
              <rect x="48" y="40" width="4" height="2" fill="#212121" /><line x1="32" y1="38" x2="46" y2="44" stroke="#424242" strokeWidth="1" />
              <path d="M 25 35 Q 50 15 75 35" fill="none" stroke="#00e5ff" strokeWidth="4" />
              <rect x="18" y="32" width="8" height="16" fill="#00b8d4" rx="4" /><rect x="74" y="32" width="8" height="16" fill="#00b8d4" rx="4" />
            </g>
            <rect x="32" y="65" width="10" height="12" fill="#1a237e" /><rect x="58" y="65" width="10" height="12" fill="#1a237e" />
            <rect x="30" y="75" width="14" height="8" fill="#ff4081" rx="2" /><rect x="56" y="75" width="14" height="8" fill="#ff4081" rx="2" />
            <rect x="30" y="81" width="14" height="2" fill="#fff" /><rect x="56" y="81" width="14" height="2" fill="#fff" />
            <rect x="70" y="50" width="10" height="10" fill="#d500f9" rx="3" />
            <g transform="rotate(-20 50 60)">
              <rect x="25" y="58" width="50" height="4" fill="#8d6e63" />
              <path d="M 25 50 L 40 50 Q 45 60 40 70 L 25 70 Q 15 60 25 50 Z" fill="#ff1744" />
              <circle cx="35" cy="60" r="4" fill="#ffffff" /><rect x="75" y="56" width="6" height="8" fill="#424242" rx="1" />
            </g>
            <g className="a-strum" style={{ transformOrigin: '30px 65px' }}>
              <rect x="28" y="55" width="10" height="12" fill="#d500f9" rx="3" />
              <polygon points="38,62 42,65 38,68" fill="#fff" />
            </g>
          </g>
        </svg>
        ...
        <svg x="780" y="530" width="180" height="180" viewBox="0 0 100 100" overflow="visible">
          <g transform="translate(50,50) scale(-1, 1) translate(-50,-50)">
            <g className="a-drive">
              <g className="a-bump">
                <rect x="20" y="80" width="55" height="6" fill="#95a5a6" rx="3" />
                <rect x="65" y="45" width="6" height="38" fill="#7f8c8d" rx="2" /><rect x="55" y="45" width="20" height="5" fill="#34495e" rx="2" />
                <g className="a-wheel" style={{ transformOrigin: '70px 86px' }}><circle cx="70" cy="86" r="6" fill="#2c3e50" /><circle cx="70" cy="86" r="2" fill="#ecf0f1" /></g>
                <rect x="28" y="82" width="4" height="4" fill="#34495e" />
                <g className="a-wheel" style={{ transformOrigin: '30px 86px' }}><circle cx="30" cy="86" r="6" fill="#2c3e50" /><circle cx="30" cy="86" r="2" fill="#ecf0f1" /></g>
                <g>
                  <rect x="25" y="35" width="35" height="30" fill="#f1c40f" rx="8" />
                  <path d="M 25 35 Q 42 15 60 35 Z" fill="#d35400" />
                  <rect x="23" y="32" width="39" height="6" fill="#e67e22" rx="2" />
                  <circle cx="40" cy="45" r="6" fill="#fff" /><circle cx="55" cy="45" r="6" fill="#fff" />
                  <circle cx="42" cy="45" r="3" fill="#000" className="a-blink" /><circle cx="57" cy="45" r="3" fill="#000" className="a-blink" />
                  <rect x="20" y="52" width="45" height="18" fill="#c0392b" rx="5" />
                  <rect x="35" y="58" width="15" height="10" fill="#e74c3c" rx="2" /><rect x="45" y="43" width="15" height="10" fill="#c0392b" rx="4" /><rect x="55" y="44" width="8" height="8" fill="#f1c40f" rx="2" />
                  <rect x="45" y="70" width="12" height="12" fill="#2980b9" /><rect x="45" y="78" width="18" height="6" fill="#d35400" rx="2" /><rect x="45" y="82" width="18" height="2" fill="#fff" />
                  <g className="a-kick" style={{ transformOrigin: '31px 70px' }}>
                    <rect x="25" y="70" width="12" height="12" fill="#2980b9" />
                    <rect x="15" y="78" width="18" height="6" fill="#d35400" rx="2" /><rect x="15" y="82" width="18" height="2" fill="#fff" />
                  </g>
                </g>
              </g>
            </g>
        ...
        <svg x="150" y="550" width="220" height="220" viewBox="0 0 100 100" overflow="visible">
          <g className="a-bounce">
            <g className="a-tail">
              <path d="M 30 35 Q 10 20 5 50 Q 25 55 30 40 Z" fill="#ffee58" />
              <rect x="25" y="32" width="6" height="10" fill="#e91e63" rx="2" transform="rotate(15 25 32)" />
            </g>
            <path d="M 50 40 Q 50 25 35 25 Q 25 25 25 40 L 25 65 L 75 65 L 75 40 Q 75 25 60 25 Q 50 25 50 40 Z" fill="#f06292" />
            <rect x="30" y="65" width="12" height="12" fill="#f06292" rx="2" /><rect x="58" y="65" width="12" height="12" fill="#f06292" rx="2" />
            <path d="M 28 77 L 44 77 L 44 83 L 28 83 Z" fill="#f8bbd0" rx="2" /><path d="M 56 77 L 72 77 L 72 83 L 56 83 Z" fill="#f8bbd0" rx="2" />
            <circle cx="38" cy="42" r="6" fill="#fff" /><circle cx="62" cy="42" r="6" fill="#fff" />
            <circle cx="40" cy="42" r="3" fill="#000" className="a-blink" /><circle cx="64" cy="42" r="3" fill="#000" className="a-blink" />
            <path d="M 34 38 L 30 35 M 36 36 L 33 32" stroke="#000" strokeWidth="2" strokeLinecap="round" />
            <path d="M 66 38 L 70 35 M 64 36 L 67 32" stroke="#000" strokeWidth="2" strokeLinecap="round" />
            <path d="M 20 50 L 30 50 L 30 65 L 20 65 Z" fill="#ab47bc" rx="2" /><path d="M 70 50 L 80 50 L 80 65 L 70 65 Z" fill="#ab47bc" rx="2" />
            <path d="M 30 50 L 35 50 L 35 65 L 30 65 Z" fill="#81d4fa" /><path d="M 65 50 L 70 50 L 70 65 L 65 65 Z" fill="#81d4fa" />
            <g className="a-photo">
              <rect x="32" y="55" width="10" height="10" fill="#f06292" rx="3" /><rect x="58" y="55" width="10" height="10" fill="#f06292" rx="3" />
              <rect x="38" y="52" width="24" height="16" fill="#424242" rx="3" /><rect x="42" y="49" width="6" height="4" fill="#212121" rx="1" />
              <circle cx="50" cy="60" r="6" fill="#90caf9" stroke="#616161" strokeWidth="2" />
              <circle cx="50" cy="60" r="2" fill="#fff" opacity="0.8" />
              <circle cx="50" cy="60" r="0" fill="#fff" className="a-flash" />
            </g>
          </g>
        </svg>
        </svg>
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen bg-[#111] text-white p-8 pb-16">
      ...
      <header className="flex items-center justify-between mb-8 max-w-7xl mx-auto">
        <div className="flex items-center gap-2 bg-[#7A9B76]/20 text-[#7A9B76] px-4 py-2 rounded-full font-bold text-sm">
          <div className="w-2 h-2 bg-[#7A9B76] rounded-full animate-pulse" /> {mode === 'eye_health' ? 'Health AI Active' : 'Focus AI Active'}
        </div>
        <button onClick={() => navigate('/home')} className="bg-white/10 hover:bg-[#E395A4] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-colors">End Session & Back</button>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl mx-auto h-[75vh]">
        <div className="lg:col-span-8 flex flex-col gap-6 h-full">
          <div className="bg-black rounded-[40px] flex-1 relative overflow-hidden border border-white/10 shadow-2xl flex items-center justify-center">
            ...
            {!videoRef.current?.srcObject && <Camera size={64} className="text-white/20" />}
            ...
            <div className="absolute bottom-6 left-6 flex items-center gap-2 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/10">
              <Target size={16} className={data.too_close ? 'text-red-400' : data.too_far ? 'text-amber-400' : 'text-[#7A9B76]'} />
          ...
          <div className="bg-white/5 rounded-[32px] p-6 border border-white/10">
            <div className="flex justify-between text-sm font-bold uppercase tracking-widest text-white/50 mb-3">
              <span>Eye Openness (EAR)</span><span className="text-[#E58C49]">{data.ear.toFixed(2)}</span>
            </div>
            <div className="h-4 bg-black/50 rounded-full overflow-hidden relative">
              <motion.div className={`absolute top-0 left-0 h-full rounded-full ${data.ear < 0.25 ? 'bg-[#E395A4]' : 'bg-[#E58C49]'}`} animate={{ width: `${Math.min(data.ear * 200, 100)}%` }} />
              <div className="absolute top-0 bottom-0 left-[50%] w-0.5 bg-white/20" />
            </div>
          </div>
        </div>

        <div className="lg:col-span-4 flex flex-col gap-6 h-full">
          <div className={`rounded-[40px] p-8 border text-center flex-1 flex flex-col items-center justify-center transition-colors ${data.too_close ? 'bg-[#E395A4]/10 border-[#E395A4]/50' : 'bg-white/5 border-white/10'}`}>
            <PixelMascot skin={user?.mascot} size={200} alertState={data.too_close || data.drowsy} />
            <div className="mt-8 h-20">
              {data.too_close ? <><h4 className="text-[#E395A4] font-bold text-xl">Too Close!</h4><p className="text-white/50 text-sm mt-1">Give me space</p></>
                : data.drowsy ? <><h4 className="text-[#E58C49] font-bold text-xl">Sleepy spotted.</h4><p className="text-white/50 text-sm mt-1">Recharge now.</p></>
                : <><h4 className="text-[#7A9B76] font-bold text-xl">Looking Good!</h4><p className="text-white/50 text-sm mt-1">Keep it up.</p></>}
            </div>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6"><p className="text-white/50 text-[10px] font-bold uppercase mb-2 tracking-wider">Session Time</p><p className="text-3xl font-black text-white">{formatTime(sessionTime)}</p></div>
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6"><p className="text-white/50 text-[10px] font-bold uppercase mb-2 tracking-wider">Total Blinks</p><p className="text-3xl font-black text-white">{totalBlinks}</p></div>
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 col-span-2 flex justify-between items-center">
              <div><p className="text-white/50 text-[10px] font-bold uppercase mb-2 tracking-wider">Blink Rate</p><p className="text-3xl font-black text-[#E58C49]">{data.bpm} <span className="text-sm text-white/50">BPM</span></p></div>
...
function TimerPage() {
  ...
  const textColor = isDark ? 'text-white' : 'text-[#3D4035]';
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen flex flex-col items-center justify-center pt-20 pb-10 relative">
      ...
      <div className="w-full flex flex-col items-center mt-16 px-6 mx-auto">
        <div className="relative mt-24 flex justify-center w-full max-w-lg">
          ...
          <div className={`relative z-10 ${cardBg} ${textColor} rounded-[40px] p-12 w-full shadow-2xl border`}>
           ...
           <div className="space-y-6 relative before:absolute before:inset-0 before:ml-2.5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-black/10 before:to-transparent">
             ...
             <div className="relative flex items-center justify-between">
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   <p className="font-bold text-sm">20-20-20 Rule</p>
                   <p className="text-xs opacity-60">Completed full session</p>
                 </div>
               </div>
             ...
             <div className="relative flex items-center justify-between">
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   <p className="font-bold text-sm">Warm Palming</p>
                   <p className="text-xs opacity-60">Streak: 3 Days</p>
                 </div>
               </div>
             ...
             <div className="relative flex items-center justify-between">
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   <p className="font-bold text-sm">Eye Health Mode</p>
                   <p className="text-xs opacity-60">45 mins tracking</p>
                 </div>
               </div>
      ...
      <div className="space-y-6">
        ...
        <section className={`${cardBg} rounded-[40px] p-8 shadow-sm border`}>
          ...
          <div className="flex items-center justify-between py-6 border-b border-black/10">
            <div>
              <p className="font-bold text-lg">Do Not Disturb</p>
              <p className="text-sm opacity-60 font-medium">Silence all alerts from Mascot.</p>
            </div>
          ...
          <div className="py-6">
            ...
            {[
                { label: 'Banner Pop-up', key: 'banner' },
                { label: 'Sound Chime', key: 'sound' },
                ...
                >
                    ...
                    className={`w-6 h-6 rounded-md border-2 flex items-center justify-center transition-colors ${
                        isChecked
                        ? 'bg-[#7A9B76] border-[#7A9B76]'
                        : 'border-black/20 group-hover:border-[#7A9B76]/50'
                    }`}
                    >
                    {isChecked && (
                    ...
                    <span className="font-bold opacity-80 group-hover:opacity-100">
                    {label}
                    </span>
                </label>
                );
